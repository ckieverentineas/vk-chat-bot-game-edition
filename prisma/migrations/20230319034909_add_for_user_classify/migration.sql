...
INSERT INTO "new_User" ("atk", "crdate", "health", "health_max", "id", "id_region", "idvk", "lvl", "mana", "name", "point", "xp") SELECT "atk", "crdate", "health", "health_max", "id", "id_region", "idvk", "lvl", "mana", "name", "point", "xp" FROM "User";
DROP TABLE "User";

/*
  ...
  - Added the required column `boss` to the `Region` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Region" ("id", "id_location", "label", "mob_max", "mob_min", "name", "road", "uid") SELECT "id", "id_location", "label", "mob_max", "mob_min", "name", "road", "uid" FROM "Region";
DROP TABLE "Region";

...
CREATE TABLE "new_User" (
    ...
    "skill" TEXT NOT NULL DEFAULT '[''Атака'']',
...
INSERT INTO "new_User" ("atk", "crdate", "health", "health_max", "id", "id_classify", "id_region", "idvk", "lvl", "mana", "name", "point", "xp") SELECT "atk", "crdate", "health", "health_max", "id", "id_classify", "id_region", "idvk", "lvl", "mana", "name", "point", "xp" FROM "User";
DROP TABLE "User";
